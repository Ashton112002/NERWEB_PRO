      ...
      <div style={{ backgroundColor: "#679641" }} className="text-gray">
        <div className="grid grid-cols-1 sm:gird-cols-3 lg:grid-cols-4 gap-6 sm:px-8 px-5 py-16 sm:text-center">
          ...
          <ul className="text-center sm:text-start -mb-5 mt-5 md:mt-0">
            ...
            <ul className="flex items-center justify-center mt-5 md:justify-start md:ml-2.5 md:mt-0">
              <li className="mr-2">
                <a
              ...
              <li className="mr-2">
                <a
                  ...
                  className="text-gray hover:text-pink-500"
                >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 text-center pt-2 text-gray text-sm pb-8">
