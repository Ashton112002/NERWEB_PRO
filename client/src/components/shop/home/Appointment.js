...
const Appointment = () => {
  ...
  const sendEmail = () => {
    const toEmail = localStorage.getItem("currentUserEmail");
    emailjs.init(EMAIL_JS_PUBLIC_KEY); // EMAIL JS PUBLIC KEY
    var params = {
      from_name: "Nanay Estralla",
      message: "Appointment already set!", // Change your message here!
      to_email: toEmail//HERE FOR EDITING EMAIL TO SEND
    }
    emailjs.send(EMAIL_JS_SERVICE_KEY,EMAIL_JS_TEMPLATE_KEY, params); // EMAIL JS CONFIGURATIUON
  }
