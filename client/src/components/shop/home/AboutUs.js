  ...
  return (
    ...
    <div className="w-full h-screen relative mb-[30%] md:mb-[0%]">
      <div className="w-full h-screen flex flex-col md:flex-row ">
        ...
        <div className="w-full md:w-1/2 bg-white flex flex-col p-5 md:p-20 mt-10 md:mt-16">
          ...
          <div className="mt-3 md:mt-4">
            <button
              type="submit"
              className="mb-6 md:mb-10 bg-[#C07936] w-28 md:w-36 h-10 md:h-12 hover:bg-[#679641] cursor-pointer m-auto text-white text-xs md:text-sm font-medium text-center py-1 rounded-full mt-3 md:mt-4 hover:-translate-y-1 hover:scale-110 hover:bg-[#679641] duration-300"
            >
              Explore Our Story
            </button>
          </div>
