...
export const CheckoutComponent = props => {
  ...
  // edit configurations here for sending email
  const sendEmail = () => {
    ...
    var params = {
      ...
      message: "Order successfully created! Please wait for the admin to process",
                ...
                <div
                  ...
                  <div className="flex flex-col py-2">
                    <label htmlFor="address" className="pb-2">
                      Your Full Detailed Delivery Address
                    </label>
                    <input
                      value={state.address}
                      onChange={e =>
