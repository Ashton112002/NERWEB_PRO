...
import { fetchData, editOrderReq, deleteOrderReq, printOrder } from './Actions';
    ...
    <Fragment>
      <tr className="border-b">
        ...
        <td className="p-2 flex items-center justify-center">
          ...
          {/* TO DO EDIT HERE TO PRINT RECEIPTTT !!!!!! */}
          <span
          onClick={downloadInvoice} 
          className="cursor-pointer hover:bg-gray-200 rounded-lg p-2 mx-1" style={{backgroundColor: 'midnightblue', color: '#fff'}}>
            Print
          </span>
